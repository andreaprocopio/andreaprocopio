...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    <div
      ref={parentRef}
      className={cn(
        "min-h-[20rem] md:min-h-[30rem] bg-gradient-to-b from-white to-neutral-100 dark:from-neutral-950 dark:to-background relative flex items-center w-full justify-center overflow-hidden",
